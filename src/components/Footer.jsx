      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#104c96] to-[#00a896] flex items-center justify-center text-white font-bold text-xs">
              KS
            </div>
            <div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 text-white bg-slate-800/80 hover:bg-slate-800 px-4 py-2 rounded-xl transition-all font-semibold border border-slate-700/60"
          >
        ...
        <div className="pt-4 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-slate-600">
