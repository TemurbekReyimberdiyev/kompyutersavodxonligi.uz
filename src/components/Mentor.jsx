...
export default function Mentor() {
  return (
    <section id="mentor" className="py-16 max-w-5xl mx-auto px-4 sm:px-6 text-left">
      {/* Sarlavha */}
      ...
      {/* Asosiy Card */}
      <div className="bg-white rounded-3xl border border-slate-200/90 shadow-lg shadow-slate-200/40 overflow-hidden p-6 sm:p-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          {/* Chap ustun: Shaxsiy Profil va Aloqa */}
          <div className="lg:col-span-4 flex flex-col items-center text-center space-y-4 border-b lg:border-b-0 lg:border-r border-slate-100 pb-8 lg:pb-0 lg:pr-8">
            <div className="relative">
              <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-2xl bg-gradient-to-br from-[#0c3160] via-[#104c96] to-[#00a896] text-white flex flex-col items-center justify-center shadow-xl ring-4 ring-slate-100">
                <span className="font-black text-4xl sm:text-5xl tracking-tight">RT</span>
                <span className="text-[10px] tracking-widest text-teal-200 uppercase font-semibold mt-1">Mentor</span>
              </div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-[#0088cc] hover:bg-[#007cb8] text-white text-xs px-5 py-3 rounded-xl font-bold shadow-md hover:shadow-lg transition-all w-full active:scale-95 cursor-pointer"
            >
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="relative bg-blue-50/50 p-5 rounded-2xl border border-blue-100/80">
              <Quote className="w-6 h-6 text-[#104c96]/30 absolute top-4 right-4" />
              <p className="text-xs sm:text-sm text-slate-700 italic font-medium leading-relaxed pr-6">
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 text-center">
                <div className="text-xl sm:text-2xl font-black text-[#104c96]">5+ yil</div>
                <div className="text-[11px] text-slate-500 mt-0.5 font-medium">Amaliy tajriba</div>
              </div>

              <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 text-center">
                <div className="text-xl sm:text-2xl font-black text-[#00a896]">1,000+</div>
                <div className="text-[11px] text-slate-500 mt-0.5 font-medium">Shogirdlar soni</div>
              </div>

              <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 text-center">
                <div className="text-xl sm:text-2xl font-black text-[#27ae60]">100%</div>
                <div className="text-[11px] text-slate-500 mt-0.5 font-medium">Amaliy natija</div>
              </div>
            </div>
          </div>
        </div>
