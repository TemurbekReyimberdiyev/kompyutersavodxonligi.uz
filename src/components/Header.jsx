    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-15 sm:h-16 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-2 sm:gap-3 group min-w-0">
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-tr from-[#0f3d75] via-[#104c96] to-[#00a896] flex items-center justify-center text-white shadow-xs group-hover:scale-105 transition-transform shrink-0">
            <svg className="w-4.5 h-4.5 sm:w-5.5 sm:h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-sm xs:text-base sm:text-lg font-black text-slate-900 tracking-tight leading-none truncate">
              kompyutersavodxonligi<span className="text-[#00a896]">.uz</span>
            </span>
            <span className="hidden xs:block text-[10px] text-slate-500 font-medium tracking-wide mt-0.5 truncate">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-1.5 sm:gap-2 bg-[#0088cc] hover:bg-[#007cb8] text-white px-2.5 sm:px-4 py-2 rounded-xl text-xs font-bold shadow-xs hover:shadow-md transition-all active:scale-95 shrink-0"
          >
          ...
          <button
            ...
            className="md:hidden w-9 h-9 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 flex items-center justify-center transition-colors cursor-pointer active:scale-95 shrink-0"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-slate-200 bg-white/95 backdrop-blur-xl px-4 pt-3 pb-5 space-y-2 shadow-lg animate-in slide-in-from-top-2 duration-150">
          <button
            onClick={() => handleNavClick('lessons')}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-50 text-slate-800 font-bold text-sm text-left transition-colors cursor-pointer active:scale-95"
          >
          ...
          <button
            onClick={() => handleNavClick('group')}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-50/70 text-blue-800 font-bold text-sm text-left transition-colors cursor-pointer active:scale-95"
          >
          ...
          <button
            onClick={() => handleNavClick('certificate')}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-50/70 text-emerald-800 font-bold text-sm text-left transition-colors cursor-pointer active:scale-95"
          >
