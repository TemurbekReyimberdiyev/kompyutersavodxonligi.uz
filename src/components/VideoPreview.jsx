...
export default function VideoPreview() {
  return (
    <section id="preview" className="py-16 bg-slate-50/70 border-b border-slate-200/80">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6">
        {/* Section Header */}
        <div className="space-y-2">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-red-50 border border-red-200/70 text-red-700 text-xs font-bold">
        ...
        {/* Video Player Frame */}
        <div className="max-w-3xl mx-auto bg-slate-900 rounded-2xl overflow-hidden shadow-2xl shadow-slate-900/15 border border-slate-700/40">
          {/* Top Frame Bar */}
          <div className="bg-slate-800/90 px-4 py-2.5 flex items-center justify-between border-b border-slate-700/50">
            ...
            <span className="text-[11px] font-medium text-slate-400 truncate max-w-xs sm:max-w-md">
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3 text-xs text-slate-600">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#0088cc] hover:bg-[#007cb8] text-white text-xs font-bold transition-all shadow-xs hover:shadow-md cursor-pointer"
          >
